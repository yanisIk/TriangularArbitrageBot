...
export const BITTREX = {
    ...
    PIVOT_CURRENCIES: ["LTC", "DASH", "XMR", "DGB", "XRP", "XEM", "XLM", "FCT", "DGD", "WAVES", "ETC", "STRAT", "REP", "NEO", "ZEC", "GNT", "LGD", "TRST", "WINGS", "RLC", "GNO", "GUP", "LUN", "HMQ", "ANT", "SC", "BAT", "1ST", "QRL", "CRB", "PTOY", "MYST", "CFI", "BNT", "NMR", "SNT", "MCO", "ADT", "FUN", "PAY", "MTL", "STORJ", "ADX", "OMG", "CVC", "QTUM", "BCC"],

    MIN_BTC_QUANTITY: 0.002,
    MIN_ETH_QUANTITY: 0.025,
    MIN_USDT_QUANTITY: 30,
    ...
    ORDER_WATCH_INTERVAL_IN_MS: 1500,
