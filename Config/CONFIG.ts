...
export const BITTREX = {
    PIVOT_MARKETS: ["BTC-ETH", "USDT-BTC", "USDT-ETH"],
    PIVOT_MARKET: "BTC-ETH",

    BTC_ETH_PIVOT_CURRENCIES: ["LTC", "DASH", "XMR", "DGB", "XRP", "XEM", "XLM", "FCT", "DGD", "WAVES", "ETC", "STRAT", "REP", "NEO", "ZEC", "GNT", "LGD", "TRST", "WINGS", "RLC", "GNO", "GUP", "LUN", "HMQ", "ANT", "SC", "BAT", "1ST", "QRL", "CRB", "PTOY", "MYST", "CFI", "BNT", "NMR", "SNT", "MCO", "ADT", "FUN", "PAY", "MTL", "STORJ", "ADX", "OMG", "CVC", "QTUM", "BCC"],
    USDT_BTC_PIVOT_CURRENCIES: ["LTC", "DASH", "XMR", "XRP", "ETH", "ETC", "NEO", "ZEC", "OMG", "BCC"],
    USDT_ETH_PIVOT_CURRENCIES: ["ETC", "LTC", "XRP", "DASH", "ZEC", "OMG", "XMR", "NEO", "BCC"],

    MIN_BTC_QUANTITY: 0.0035,
    MIN_ETH_QUANTITY: 0.035,
    MIN_USDT_QUANTITY: 35,

    MAX_BTC_QUANTITY: 0.006,
    MAX_ETH_QUANTITY: 0.10,
    MAX_USDT_QUANTITY: 100,

    MIN_PROFIT_PERCENTAGE: 0.4,
    TRANSACTION_FEE_PERCENTAGE: 0.25,

    UNFILLED_ORDERS_TIMEOUT: 10000,

    ORDER_WATCH_INTERVAL_IN_MS: 1000,
    TICK_POLL_INTERVAL_IN_MS: 100,
    ORDERBOOK_POLL_INTERVAL_IN_MS: 100,
    WALLET_WATCH_INTERVAL: 2000,
    WALLET_LOG_INTERVAL: 10000,
